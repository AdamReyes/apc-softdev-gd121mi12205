...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2015 at 07:13 AM
...
--
CREATE DATABASE IF NOT EXISTS `softdev_espinola_francesca_ann` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `softdev_espinola_francesca_ann`;
